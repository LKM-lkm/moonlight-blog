...
const responses = {
    ...
    '这个网站是做什么的': '这是一个名为Moonlight的个人博客系统，主要分享技术文章、生活感悟和各类有趣的内容。',
    '如何联系网站管理员': '您可以通过页面底部的联系方式与管理员取得联系，或者发送邮件至lkm836972@outlook.com。',
    '微信': '您可以添加博主微信号：likeme2010Ming 进行联系。',
    '如何找到最新的文章': '您可以点击首页的"最新文章"栏目，或者使用顶部导航栏的搜索功能，按发布日期排序。',
    '推荐几篇热门文章': '暂无，您可以在首页的"热门推荐"栏目寻找。',
    '再见': '感谢您的使用！如果还有其他问题，随时欢迎回来咨询。祝您有愉快的一天！',
    '谢谢': '不客气！很高兴能帮到您。还有其他问题吗？',
    '作者简介': '我是名，初三学生，热爱技术和创新，专注于绘画、文字排版，人工智能、云计算和大数据领域的研究与应用。喜欢探索新技术，用代码创造美好的数字世界。'
};
